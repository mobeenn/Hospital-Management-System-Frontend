         ...
         >
            ...
            <div className="flex items-center justify-between gap-3 border-b border-slate-800 px-6 py-5">
               <div className="flex items-center gap-3">
                  <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-cyan-500 text-lg text-white shadow-lg shadow-cyan-500/30">
                     <FaHospital />
                  </div>
            ...
            <div className="border-t border-slate-800 px-4 py-4">
               ...
               <button
                  type="button"
                  onClick={onLogout}
                  className="flex w-full items-center justify-center gap-2 rounded-xl bg-red-500/10 px-3 py-2.5 text-sm font-semibold text-red-400 transition-colors duration-200 hover:bg-red-500 hover:text-white"
               >
                  <FaSignOutAlt />
                  Logout
               </button>
